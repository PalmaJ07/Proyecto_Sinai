...
class ProductoSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Producto
        fields = ['encrypted_id','id', 'config_categoria', 'config_marca', 'descripcion', 'codigo',
...
class ProductoDetalleSerializer(serializers.ModelSerializer):
    ...
    almacen = serializers.PrimaryKeyRelatedField(queryset=ConfigAlmacen.objects.all(), required=False, allow_null=True)
    proveedor = serializers.PrimaryKeyRelatedField(queryset=ConfigProveedor.objects.all())
    n_producto = serializers.CharField(source='producto.descripcion', read_only=True)
...
class ProductoDetalleIngresoSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ['encrypted_id','id', 'producto', 'producto_detalle', 'config_almacen', 
...
class ProductoDevolucionSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ['encrypted_id','id', 'producto_detalle', 'cantidad_por_presentacion', 
...
class ProductoMovimientoSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ['encrypted_id','id', 'producto_detalle_origen', 'producto_detalle_destino', 
